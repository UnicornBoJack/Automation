...
class ToastMatcher(private val maxFailures: Int = DEFAULT_MAX_FAILURES) : TypeSafeMatcher<Root>() {
    ...
    public override fun matchesSafely(root: Root): Boolean {
        ...
        // Method is called again if false is returned which is useful because a toast may take
        // some time to pop up. But for
        // obvious reasons an infinite wait isn't of help. So false is only returned as often as
        // maxFailures specifies.
    ...
    companion object {
        ...
        fun onToast(textId: Int, maxRetries: Int = DEFAULT_MAX_FAILURES) = onView(withText(textId))
            .inRoot(isToast(maxRetries))!!
